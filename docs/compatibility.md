...
Current upstream-aligned downstream version: **0.3.12**.

| Platform | Runtime | Open bug reports | Closed bug reports | Signal |
| --- | --- | ---: | ---: | --- |
| Windows | Tauri 2 + Rust | 0 | 0 | No open reports |
| Android | Jetpack Compose + Rust | 0 | 0 | No open reports |
| Linux | Tauri 2 + Rust | 0 | 0 | No open reports |
| Web / PWA / Docker | Web/PWA | 0 | 0 | No open reports |
| macOS | Upstream-aligned SwiftUI | 0 | 0 | No open reports |

## Recent open compatibility reports

No open structured compatibility bug reports.
