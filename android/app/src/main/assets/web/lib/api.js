...
const getClient = () => (typeof window !== 'undefined' && window.NeteaseClient ? window.NeteaseClient.client : neteaseClientModule.client);
const getDecode = () => (typeof window !== 'undefined' && window.NeteaseClient ? window.NeteaseClient.decode : neteaseClientModule.decode);
