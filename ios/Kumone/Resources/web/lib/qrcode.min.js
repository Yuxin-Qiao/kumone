/**
 * QRCode generator for JavaScript (lightweight standalone version)
 * Adapted for Kumone Android / Web
 */
(function (global) {
  var QRCode = {};
  ...
  QRCode.toDataURL = function (text, options) {
    ...
    var qr = null;
    var lastErr = null;
    // Version 4-M overflows typical NetEase login URLs; the bundled table supports 1-5.
    for (var typeNumber = 4; typeNumber <= 5; typeNumber++) {
      try {
        var candidate = new QRCodeModel(typeNumber, QRErrorCorrectLevel.M);
